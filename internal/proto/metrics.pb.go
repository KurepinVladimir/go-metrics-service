...
type Metric struct {
	...
	// Поле delta для метрик-счётчиков. // для counter
	Delta int64 `protobuf:"varint,3,opt,name=delta,proto3" json:"delta,omitempty"`
	// Поле value для метрик-измерителей. // для gauge
...
const file_internal_proto_metrics_proto_rawDesc = "" +
	...
	"\aMetrics\x12N\n" +
	"\rUpdateMetrics\x12\x1d.metrics.UpdateMetricsRequest\x1a\x1e.metrics.UpdateMetricsResponseBGZEgithub.com/KurepinVladimir/go-musthave-metrics-tpl.git/internal/protob\x06proto3"
